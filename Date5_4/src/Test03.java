...
public class Test03 {
	...
	public static void main(String[] args) {
		...
		vector.insertElementAt("ÆÄ¸®", 2); print(3, vector);
		vector.setElementAt("·±´ø", 1); print(4, vector);
		...
		vector.removeElement("´º¿å"); print(6, vector);
		vector.removeElement(1); print(7, vector);
